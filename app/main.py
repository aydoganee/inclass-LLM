...
def route_list_my_courses_alias(body: ListMyCoursesBody):
    return listMyCourses(body.email, body.password)
...
@app.post("/instructor/log-manual-score")
def route_log_manual_score(body: ManualGradeBody):
    return logManualScore(
        body.email, 
        body.password, 
        body.course_id, 
        body.activity_no, 
